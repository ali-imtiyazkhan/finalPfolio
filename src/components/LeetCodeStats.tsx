    ...
    <div className="flex flex-col gap-2">
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm text-[var(--text-muted)]">
          <span className="font-semibold text-[var(--text-primary)]">{solved}</span>/{total}
        </span>
      </div>
      <div className="h-2.5 w-full overflow-hidden rounded-full bg-[var(--pill-bg)]">
        <m.div
        ...
        <div className="flex flex-col gap-8 md:flex-row md:gap-12">
          ...
          <div className="flex flex-col items-center justify-center gap-3">
            ...
            <div className="flex gap-4 text-center">
              <div className="flex flex-col">
                <span className="text-lg font-bold text-[var(--text-primary)]">{LEETCODE_STATS.contestRating}</span>
                <span className="text-[10px] uppercase tracking-wider text-[var(--text-muted)]">Rating</span>
              </div>
              <div className="h-8 w-px bg-[var(--border)]" />
              <div className="flex flex-col">
                <span className="text-lg font-bold text-[var(--text-primary)]">{LEETCODE_STATS.maxStreak}</span>
                <span className="text-[10px] uppercase tracking-wider text-[var(--text-muted)]">Max Streak</span>
              </div>
              <div className="h-8 w-px bg-[var(--border)]" />
              <div className="flex flex-col">
                <span className="text-lg font-bold text-[var(--text-primary)]">Top {LEETCODE_STATS.topPercentage}%</span>
                <span className="text-[10px] uppercase tracking-wider text-[var(--text-muted)]">Contest</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-1 flex-col justify-center gap-5">
            ...
            <a
              ...
              className="mt-2 flex items-center gap-2 text-sm font-medium text-[var(--text-muted)] transition-colors hover:text-[var(--text-primary)]"
            >
