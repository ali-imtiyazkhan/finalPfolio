...
import { TiltedWrapperProps } from "@/components/ui/TiltedWrapper"
...
export const TiltedWrapper = /*#__PURE__*/ dynamic(() => import("@/components/ui/TiltedWrapper").then((m) => m.TiltedWrapper), {
  ssr: false,
  loading: () => null,
})
